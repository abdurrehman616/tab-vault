...
export { computeReorderedSavedTabs, isSameSavedTabsOrder, MOVE_TO_END } from './reorderSavedTabs';
export { computeToggledFavorite } from './toggleSavedTabFavorite';
export { persistSavedTabs } from './persistSavedTabs';
export type { PersistSavedTabsResult } from './persistSavedTabs';
